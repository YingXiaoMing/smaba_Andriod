...
public class MultilevelAdapter2 extends BaseAdapter {
    private Context context;
    private List<String> list;
    private LayoutInflater inflater;
    public static Map<Integer,Boolean> isSelected;

    public MultilevelAdapter2(Context context, List<String> list,String machineName) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        MultilevelAdapter2.viewHolder viewHolder = null;
        if (viewHolder == null) {
            convertView = inflater.inflate(R.layout.radio_item,parent,false);
            viewHolder = new MultilevelAdapter2.viewHolder();
            ...
            viewHolder = (MultilevelAdapter2.viewHolder) convertView.getTag();
        }
