...
public class MultilevelAdapter4 extends BaseAdapter {
    private Context context;
    private List<String> list;
    private LayoutInflater inflater;
    public static Map<Integer,Boolean> isSelected;
    public MultilevelAdapter4(Context context, List<String> list, String machineName) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        MultilevelAdapter4.viewHolder viewHolder = null;
        if (viewHolder == null) {
            convertView = inflater.inflate(R.layout.radio_item,parent,false);
            viewHolder = new MultilevelAdapter4.viewHolder();
            ...
            viewHolder = (MultilevelAdapter4.viewHolder) convertView.getTag();
        }
